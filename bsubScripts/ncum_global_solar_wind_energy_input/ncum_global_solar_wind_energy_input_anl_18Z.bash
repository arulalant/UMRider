...
#BSUB -J u2g2swe              # job name
#BSUB -W 06:00                # wall-clock time (hrs:mins)
#BSUB -n 4                    # number of tasks in job
#BSUB -x                      # exclusive mode
#BSUB -q ultra                # queue
#BSUB -e /gpfs3/home/umfcst/UMRiderLogs/solar_wind_energy/0p25/bsub/um2grb2.anl.18hr.err.%J.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o /gpfs3/home/umfcst/UMRiderLogs/solar_wind_energy/0p25/bsub/um2grb2.anl.18hr.out.%J.hybrid     # output file name in which %J is replaced by the job ID

# find out the directory of this bash script after submitted to bsub
DIR="$( cd "$( dirname "${BASH_SOURCE[1]}" )" && pwd )"

# get the absolute path of the local table 
localTable_relative_dir="$DIR/../../ables/local/ncmr/v1/"
...
export UMRIDER_SETUP=$DIR/ncum_global_solar_wind_energy_input_um2grb2_setup.cfg
export UMRIDER_VARS=$DIR/ncum_global_solar_wind_energy_input_um2grb2_vars.cfg
