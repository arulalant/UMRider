...
#BSUB -q ultra                # queue
#BSUB -e /gpfs3/home/umfcst/UMRiderLogs/solar_wind_energy/0p25/bsub/um2grb2.anl.12hr.err.%J.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o /gpfs3/home/umfcst/UMRiderLogs/solar_wind_energy/0p25/bsub/um2grb2.anl.12hr.out.%J.hybrid     # output file name in which %J is replaced by the job ID
