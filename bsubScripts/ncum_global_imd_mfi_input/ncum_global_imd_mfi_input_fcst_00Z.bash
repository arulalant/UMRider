...
#BSUB -J u2g2mfi              # job name
#BSUB -W 06:00                # wall-clock time (hrs:mins)
#BSUB -n 40                   # number of tasks in job
#BSUB -q ultra                # queue
#BSUB -e /gpfs3/home/umfcst/UMRiderLogs/mfi/bsub/um2grb2.fcst.00hr.err.%J.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o /gpfs3/home/umfcst/UMRiderLogs/mfi/bsub/um2grb2.fcst.00hr.out.%J.hybrid     # output file name in which %J is replaced by the job ID
