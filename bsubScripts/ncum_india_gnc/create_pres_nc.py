...
import os, subprocess, datetime, getopt, sys, iris, time 
...
def createNetCdfFile(path, today, utc):    
    ...
    cdir = os.getcwd()
    os.chdir(path)
    filename = 'pres_%shr_%s_00Z.grib2'
    outfile = 'pres_%s.nc' % today
...
if __name__ == '__main__':
    ...
    oftype = None
    utc = None
    helpmsg = 'create_sfc_nc.py --date=20160302 --outpath=path --oftype=analysis --utc=00'
    try:
