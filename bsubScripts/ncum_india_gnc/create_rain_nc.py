...
def createNetCdfFile(path, today, utc):    
    ...
    cdir = os.getcwd()
    os.chdir(path)
    filename = 'rain_%shr_%s_00Z.grib2'
    outfile = 'rain_%s.nc' % today
...
if __name__ == '__main__':
    ...
    oftype = None
    utc = None
    helpmsg = 'create_rain_nc.py --date=20160302 --outpath=path --oftype=analysis --utc=00'
    try:
