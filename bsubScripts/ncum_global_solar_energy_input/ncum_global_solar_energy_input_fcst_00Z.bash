...
#BSUB -J u2g2hyc              # job name
#BSUB -W 06:00                # wall-clock time (hrs:mins)
#BSUB -n 16                   # number of tasks in job (max task in one node)
#BSUB -x                      # exclusive mode
#BSUB -R span[ptile=16]       # task per node 
#BSUB -q ultra             	  # queue
#BSUB -e /gpfs3/home/umfcst/UMRiderLogs/solar/bsub/um2grb2.fcst.00hr.err.%J.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o /gpfs3/home/umfcst/UMRiderLogs/solar/bsub/um2grb2.fcst.00hr.out.%J.hybrid     # output file name in which %J is replaced by the job ID
...
export UMRIDER_SETUP=$DIR/ncum_global_solar_energy_input_um2grb2_setup.cfg
export UMRIDER_VARS=$DIR/ncum_global_solar_energy_input_um2grb2_vars.cfg
