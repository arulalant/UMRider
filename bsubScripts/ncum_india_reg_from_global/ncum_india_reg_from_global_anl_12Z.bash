...
#BSUB -q small                # queue
#BSUB -e um2grb2.anl.12hr.err.%J.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o um2grb2.anl.12hr.out.%J.hybrid     # output file name in which %J is replaced by the job ID
