...
#BSUB -J tigcum[1-45:1]       # job name selecting variable index %5 forces to
                              # run only 5 jobs concurrently
####BSUB -J tigg2g2cum[1-6:1]    # job name selecting variable index
...
#BSUB -e /gpfs3/home/umeps/UMRiderLogs/tigge/bsub/um2grb2.tigcum.err.%J.%I.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o /gpfs3/home/umeps/UMRiderLogs/tigge/bsub/um2grb2.tigcum.out.%J.%I.hybrid     # output file name in which %J is replaced by the job ID
...
export UMRIDER_VARS=$DIR/ncumeps_global_tigge_cummulative_vars.cfg
