...
#BSUB -J tig2d2[1-45:1]        # job name selecting variable index %5 forces to
...
#BSUB -e /gpfs3/home/umeps/UMRiderLogs/tigge/bsub/um2grb2.tig2d2.err.%J.%I.hybrid     # error file name in which %J is replaced by the job ID
#BSUB -o /gpfs3/home/umeps/UMRiderLogs/tigge/bsub/um2grb2.tig2d2.out.%J.%I.hybrid     # output file name in which %J is replaced by the job ID
...
export UMRIDER_VARS=$DIR/ncumeps_global_tigge_2ds2_vars.cfg
