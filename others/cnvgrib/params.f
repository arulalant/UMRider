...
! Added 11/03/2016 By Arulalan.T, Project Scientist - C, NCMRWF, India 
! based on NCUM Grib2 param details. For timebeing, we included only
! OSF required variables, but ultimately we need to include all the 
! unsupported NCUM grib2 to grib1 param details here [todo]!
       data paramlist(776) /gribparam(2,204,0,4,7,'DSWRF')/
       data paramlist(777) /gribparam(2,211,0,4,8,'USWRF')/
