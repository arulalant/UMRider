...
hour : 06
Output : It creates analysis - 1 file (um_ana_006hr_date.grib2).
...
if isinstance(date, tuple):
    ...
    while sDay <= eDay:
        ...
        convertAnlFiles(inPath, outPath, tmpPath, startdate, hr='06', lprint=debug)
    ...
    convertAnlFiles(inPath, outPath, tmpPath, date, hr='06', lprint=debug)
