...
UTC : 12Z
fcst hour : 12hr
Output : It creates analysis - 1 file (um_ana_012hr_date_12Z.grib2).
...
if isinstance(date, tuple):
    ...
    print "So um2grb2 ana 12hr conversion - from %s to %s" % (startdate, enddate)
elif isinstance(date, str):
    # only single date
    startdate, enddate = date, date
    print "Got single string date"
    print "So um2grb2 ana 12hr conversion - on %s" % date
